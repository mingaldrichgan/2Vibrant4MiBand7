const WIDGET_TYPES = {
  ...
  ALARM_CLOCK: { url: "AlarmInfoScreen", hasColon: true, padding: 1 },
  STOP_WATCH: { url: "StopWatchScreen", hasColon: true },
  TIMER: {
    type: { value: 14, en: "Timer (Toolbox)", sc: "定时器 (工具箱)", tc: "定时器 (工具箱)" },
